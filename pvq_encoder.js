...
function _od_pvq_search_rdo_double(i23, i22, i18, i24, d3, i19) {
 i23 = i23 | 0;
 i22 = i22 | 0;
 i18 = i18 | 0;
 i24 = i24 | 0;
 d3 = +d3;
 i19 = i19 | 0;
 var i1 = 0, d2 = 0.0, d4 = 0.0, i5 = 0, d6 = 0.0, i7 = 0, d8 = 0.0, d9 = 0.0, i10 = 0, i11 = 0, i12 = 0, i13 = 0, i14 = 0, d15 = 0.0, d16 = 0.0, d17 = 0.0, d20 = 0.0, i21 = 0;
 i21 = (i22 | 0) > 0;
 if (i21) {
  i1 = 0;
  d2 = 0.0;
  do {
   d20 = +Math_abs(+(+HEAPF64[i23 + (i1 << 3) >> 3]));
   HEAPF64[i19 + 160 + (i1 << 3) >> 3] = d20;
   d2 = d2 + d20 * d20;
   i1 = i1 + 1 | 0;
  } while ((i1 | 0) != (i22 | 0));
  d20 = d2;
 } else d20 = 0.0;
 d17 = 1.0 / +Math_sqrt(+(d20 + 1.0e-30));
 d16 = .147 / (d3 + 1.0e-30);
 if ((i18 | 0) > 2) if (i21) {
  i1 = 0;
  d2 = 0.0;
  do {
   d2 = d2 + +HEAPF64[i19 + 160 + (i1 << 3) >> 3];
   i1 = i1 + 1 | 0;
  } while ((i1 | 0) != (i22 | 0));
  d4 = 1.0 / d2;
  if (i21) {
   ...
   d2 = 0.0;
   do {
    d15 = +HEAPF64[i19 + 160 + (i5 << 3) >> 3];
    i14 = ~~+Math_floor(+(d4 * (d6 * d15)));
    HEAP32[i24 + (i5 << 2) >> 2] = i14;
    d3 = d3 + d15 * +(i14 | 0);
    d2 = d2 + +(Math_imul(i14, i14) | 0);
    i1 = i14 + i1 | 0;
    i5 = i5 + 1 | 0;
   } while ((i5 | 0) != (i22 | 0));
   i5 = i1;
 ...
 if ((i5 | 0) < (i18 + -1 + i1 | 0)) {
  ...
  do {
   if (i21) {
    ...
    i1 = 0;
    while (1) {
     d4 = d3 + +HEAPF64[i19 + 160 + (i7 << 3) >> 3];
     d6 = d2 + +(HEAP32[i24 + (i7 << 2) >> 2] << 1 | 0) + 1.0;
     d4 = d4 * d4;
     if (!i7) i11 = 31; else if (d9 * d4 > d8 * d6) i11 = 31; else {
      d4 = d8;
      d6 = d9;
     }
     if ((i11 | 0) == 31) {
     ...
     i7 = i7 + 1 | 0;
     if ((i7 | 0) == (i22 | 0)) break; else {
      d8 = d4;
      d9 = d6;
     }
    }
   } else i1 = 0;
   d3 = d3 + +HEAPF64[i19 + 160 + (i1 << 3) >> 3];
   i14 = i24 + (i1 << 2) | 0;
   i13 = HEAP32[i14 >> 2] | 0;
   d2 = d2 + +(i13 << 1 | 0) + 1.0;
   HEAP32[i14 >> 2] = i13 + 1;
 ...
 do if ((i5 | 0) < (i18 | 0)) {
  ...
  if (!i21) {
   ...
   do {
    i5 = ~~(d2 + 0.0 + 1.0);
    if ((i5 | 0) < 17) d4 = +HEAPF64[i19 + (i5 + -1 << 3) >> 3]; else d4 = 1.0 / +Math_sqrt(+(+(i5 | 0)));
    HEAPF64[i11 >> 3] = d4;
    i5 = ~~(d2 + 2.0 + 1.0);
    if ((i5 | 0) < 17) d4 = +HEAPF64[i19 + (i5 + -1 << 3) >> 3]; else d4 = 1.0 / +Math_sqrt(+(+(i5 | 0)));
    HEAPF64[i12 >> 3] = d4;
  ...
  do {
   i1 = ~~(d2 + 0.0 + 1.0);
   if ((i1 | 0) < 17) d4 = +HEAPF64[i19 + (i1 + -1 << 3) >> 3]; else d4 = 1.0 / +Math_sqrt(+(+(i1 | 0)));
   HEAPF64[i11 >> 3] = d4;
   i1 = ~~(d2 + 2.0 + 1.0);
   if ((i1 | 0) < 17) d4 = +HEAPF64[i19 + (i1 + -1 << 3) >> 3]; else d4 = 1.0 / +Math_sqrt(+(+(i1 | 0)));
   HEAPF64[i12 >> 3] = d4;
   ...
   i1 = 0;
   while (1) {
    d6 = d3 + +HEAPF64[i19 + 160 + (i10 << 3) >> 3];
    i7 = HEAP32[i24 + (i10 << 2) >> 2] | 0;
    do if ((i7 | 0) < 4) d4 = +HEAPF64[i19 + 128 + (i7 << 3) >> 3]; else {
     i7 = ~~(d2 + +(i7 << 1 | 0) + 1.0);
     if ((i7 | 0) < 17) {
      d4 = +HEAPF64[i19 + (i7 + -1 << 3) >> 3];
      break;
     } else {
      d4 = 1.0 / +Math_sqrt(+(+(i7 | 0)));
      break;
     }
    } while (0);
    d4 = d17 * (d6 * 2.0) * d4 - d15 * (d16 * +(i10 | 0));
    i7 = (i10 | 0) == 0 | d4 > d8;
    i1 = i7 ? i10 : i1;
    i10 = i10 + 1 | 0;
    if ((i10 | 0) == (i22 | 0)) break; else d8 = i7 ? d4 : d8;
   }
   i10 = HEAP32[i24 + (i1 << 2) >> 2] | 0;
   d3 = d3 + +HEAPF64[i19 + 160 + (i1 << 3) >> 3];
   d2 = d2 + +(i10 << 1 | 0) + 1.0;
   HEAP32[i24 + (i1 << 2) >> 2] = i10 + 1;
   i5 = i5 + 1 | 0;
  } while ((i5 | 0) != (i18 | 0));
 } while (0);
 if (i21) i1 = 0; else {
 ...
 do {
  if (+HEAPF64[i23 + (i1 << 3) >> 3] < 0.0) {
   i21 = i24 + (i1 << 2) | 0;
   HEAP32[i21 >> 2] = 0 - (HEAP32[i21 >> 2] | 0);
  }
  i1 = i1 + 1 | 0;
 } while ((i1 | 0) != (i22 | 0));
 d20 = d20 * d2;
...
function _od_pvq_rate(i8, i5, i9, i10, i4, i2, i3, i6, i7) {
 ...
 i6 = i6 | 0;
 i7 = i7 | 0;
 var d1 = 0.0, d11 = 0.0, d12 = 0.0;
 do if ((i2 | 0) > 0) {
  d12 = +(i3 + i2 | 0);
  d11 = +(i2 + 1 | 0);
  d1 = +(i3 | 0);
  d1 = ((d12 + -.5) * +Math_log(+d12) + 1.0 / (d12 * 12.0) + .08106146679532733 - ((d11 + -.5) * +Math_log(+d11) + 1.0 / (d11 * 12.0)) - ((d1 + -.5) * +Math_log(+d1) + 1.0 / (d1 * 12.0))) / .6931471805599453;
  if (!i4) {
   d1 = +(((i3 | 0) < (i2 | 0) ? i3 ^ i2 : 0) ^ i2 | 0) + d1;
   break;
  }
  if ((i3 | 0) > 0) {
   i2 = 0;
   do {
    d1 = d1 + +((HEAP32[i4 + (i2 << 2) >> 2] | 0) != 0 | 0);
    i2 = i2 + 1 | 0;
   } while ((i2 | 0) != (i3 | 0));
  }
 } else d1 = 0.0; while (0);
 if ((i8 | 0) > 0 & (i9 | 0) > -1) {
  d12 = d1 + +Math_log(+(+(i10 | 0))) * 1.4426950408889634 * .9;
  d12 = (i6 | 0) != 0 & (i7 | 0) == 0 ? d12 + 6.0 : d12;
  return +((i8 | 0) == (i5 | 0) ? d12 + -.5 : d12);
 } else return +d1;
 return 0.0;
}
